...
QT_MOC_LITERAL(1, 16, 20), // "hideDescriptionEvent"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 20), // "showDescriptionEvent"
QT_MOC_LITERAL(4, 59, 15) // "showDescription"

    },
    "AbstractControl\0hideDescriptionEvent\0"
    "\0showDescriptionEvent\0showDescription"
};
#undef QT_MOC_LITERAL
...
void AbstractControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hideDescriptionEvent(); break;
        case 1: _t->showDescriptionEvent(); break;
