...
QT_MOC_LITERAL(10, 99, 16), // "FrogPilotUIState"
QT_MOC_LITERAL(11, 116, 2) // "fs"

    },
    "OnroadWindow\0mapPanelRequested\0\0"
    "offroadTransition\0offroad\0primeChanged\0"
    "prime\0updateState\0UIState\0s\0"
...
void OnroadWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->updateState((*reinterpret_cast< const UIState(*)>(_a[1])),(*reinterpret_cast< const FrogPilotUIState(*)>(_a[2]))); break;
        default: ;
        }
