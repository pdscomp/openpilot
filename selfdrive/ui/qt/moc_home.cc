...
QT_MOC_LITERAL(16, 152, 16), // "FrogPilotUIState"
QT_MOC_LITERAL(17, 169, 2) // "fs"
    ...
    "showMapPanel\0updateState\0UIState\0s\0"
    "FrogPilotUIState\0fs"
};
#undef QT_MOC_LITERAL
...
void HomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->updateState((*reinterpret_cast< const UIState(*)>(_a[1])),(*reinterpret_cast< const FrogPilotUIState(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
